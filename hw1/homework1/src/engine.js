...
function GAMES202Main() {
	...
	let lightUp = [0, 1, 0];
	let lightPos2 = [80, 80, 0];
	const directionLight = new DirectionalLight(5000, [1, 1, 1], lightPos, focalPoint, lightUp, true, renderer.gl);
	const directionLight2 = new DirectionalLight(5000, [1, 0, 1], lightPos2, focalPoint, lightUp, true, renderer.gl);
	...
	// let cubeTransform = setTransform(30, 0, -40, 10, 50, 10);
